...
export class StyleDirective{
  ...
  @Input('app-style') color! : string
  @Input('dStyle') dStyle !: {border?: string, fontWeight?: string, borderRadius?: string}

  @HostBinding('style.color') elStyle! : any
